...
describe('FabricLabelComponent', () => {
  ...
  it('should have class root-37 when disabled', () => {
    component.content = 'FooBar Content';
    ...
    expect(debugElement.nativeElement.querySelector('label').outerHTML).toContain('root-37');
  });
  ...
  it('should remove the root-37 class when disabled is set to false', () => {
    component.content = 'FooBar Content';
    component.disabled = true;
    component.ngOnChanges({
      content: new SimpleChange(null, component.content, false),
    ...
    expect(debugElement.nativeElement.querySelector('label').outerHTML).not.toContain('root-37');
  });
